...
int		load_all(t_texture *t, Uint32 format, t_doom *d)
{
	...
	if (!(t->fonts[MENU_F].text_font = TTF_OpenFont("fonts/doom.ttf", 75)))
		return (error_message("failed to malloc textures"));
	t->wall_tex[0] = load_tex("./materials/textures/walls/WALL2.png", format);
	t->wall_tex[1] = load_tex("./materials/textures/walls/WALL.png", format);
	t->wall_tex[2] = load_tex("./materials/textures/walls/WALL-1.png", format);
	t->wall_tex[3] = load_tex("./materials/textures/walls/WALL1.png", format);
	t->wall_tex[4] = load_tex("./materials/textures/walls/colorstone.png", format);
	t->wall_tex[5] = load_tex("./materials/textures/walls/wood.png", format);
...
{
	d->texture.sprt = (t_sprite_sheet*)malloc(sizeof(t_sprite_sheet) * 9);
	...
	d->texture.sprt[7].sprites = split_surf(10, 5, "./materials/textures/sprites/enemy1.png", d);
	d->texture.sprt[7].c_sprt = 50;
	d->texture.sprt[7].w = 10;
	d->texture.sprt[7].h = 5;
	d->texture.sprt[8].sprites = split_surf(6, 5, "./materials/textures/sprites/enemy2.png", d);
