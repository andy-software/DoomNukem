...
int		main(int argc, char **argv)
{
	...
	map.sectors->vert[0].x = 0;
	map.sectors->vert[0].y = -30;
	map.sectors->vert[4].x = -30;
	map.sectors->vert[4].y = -10;
	map.sectors->vert[3].x = -20;
	map.sectors->vert[3].y = 30;
	map.sectors->vert[2].x = 20;
	map.sectors->vert[2].y = 30;
	map.sectors->vert[1].x = 30;
	map.sectors->vert[1].y = -10;

	for (int i = 0; i < map.sectors->num_vert; i++)
		map.sectors->neighbors[i] = 0;
