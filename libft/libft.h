...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/10/26 14:35:23 by apavlov           #+#    #+#             */
/*   Updated: 2018/11/07 14:37:08 by apavlov          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char			*ft_strncat(char *restrict s1, const\
							char *restrict s2, size_t n);
size_t			ft_strlcat(char *restrict dst, const\
...
int				ft_abs(int a);
long long int	ft_int_power(long long int a, long long int pow);
